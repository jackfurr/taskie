...
process.env.AUTH0_CALLBACK_URL = process.env.AUTH0_CALLBACK_SCHEMA + '://' + process.env.AUTH0_CALLBACK_SERVER + ':'+ process.env.LISTEN_PORT + '/' + process.env.AUTH0_CALLBACK_PATH;
